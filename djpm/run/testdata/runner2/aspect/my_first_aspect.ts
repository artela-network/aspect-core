    ...
    postTxExecute(input: AspectInput): AspectOutput {
        ...
        if (input.tx != null) {
            ...
            if (tom_balance_latest == null) {
                ...
                Context.setContext("account_person_tome_account_latest", tom_balance_latest!.account);
                // Context.setContext("account_person_tome_balance_latest", tom_balance_latest!.change.toString());
            }
        }
        return ret;
    }
