...
var Generator = /** @class */ (function () {
    function Generator(layoutPath, tsPath) {
        ...
        this.endBracket = "}\n";
        this.argsTemplage = "addr: string;\n    prefix: Uint8Array;\n";
        this.argsTemplageStruct = "addr: string;\n    variable: string;\n    prefix: Uint8Array;\n";
        this.constructorTemplate = "constructor(addr: string, prefix: Uint8Array = new Uint8Array(0)) {\n      this.addr = addr;\n      this.prefix = prefix;\n    }\n";
        this.constructorTemplateStruct = "constructor(addr: string, varibale: string, prefix: Uint8Array = new Uint8Array(0)) {\n      this.addr = addr;\n      this.variable = varibale;\n      this.prefix = prefix;\n    }\n";
    ...
    Generator.prototype.getBeforeFuncMap = function (typeTag, paramPrefix, valueFunc, isNumber) {
        ...
        var message = "public before(key: string): State<".concat(param1, "> | null {\n    let changes = Context.getStateChanges(this.addr, \"").concat(param2, "\", this.prefix+key);\n    if (changes.all.length == 0) {\n        return null;\n    }\n\n    let account = changes.all[0].account;\n    ").concat(param4, "\n    return new State(account, value);\n  }\n");
        return message;
    };
    ...
    Generator.prototype.getStructParam = function (name, wrapName) {
        var param1 = name;
        var param2 = wrapName;
        var message = "public ".concat(param1, "(): ").concat(param2, " {\n        let encoded = Abi.encodeString(\"").concat(param1, "\");\n        return new ").concat(param2, "(this.addr, this.variable, Utils.concatUint8Arrays(this.prefix, encoded));\n    }\n");
        return message;
    };
    Generator.prototype.getMappintSecondParam = function (name, type, prefix) {
        ...
        var message = "public ".concat(param1, "(key: string): ").concat(param2, " {\n        let encoded = Abi.encodeString(key);\n        return new ").concat(param2, "(this.addr, \"").concat(param3, "\", Utils.concatUint8Arrays(this.prefix, encoded))\n    }\n");
        return message;
    };
    return Generator;
}());
