...
type Transaction struct {
	...
	BlockHash        []byte  `protobuf:"bytes,1,req,name=block_hash,json=blockHash" json:"block_hash,omitempty"`
	BlockNumber      *uint64 `protobuf:"varint,2,req,name=block_number,json=blockNumber" json:"block_number,omitempty"`
	From             []byte  `protobuf:"bytes,3,opt,name=from" json:"from,omitempty"`
	Gas              *uint64 `protobuf:"varint,4,opt,name=gas" json:"gas,omitempty"`
	GasPrice         *uint64 `protobuf:"varint,5,opt,name=gas_price,json=gasPrice" json:"gas_price,omitempty"`
	GasFeeCap        *uint64 `protobuf:"varint,6,opt,name=gas_fee_cap,json=gasFeeCap" json:"gas_fee_cap,omitempty"`
	GasTipCap        *uint64 `protobuf:"varint,7,opt,name=gas_tip_cap,json=gasTipCap" json:"gas_tip_cap,omitempty"`
	Hash             []byte  `protobuf:"bytes,8,req,name=hash" json:"hash,omitempty"`
	Input            []byte  `protobuf:"bytes,9,opt,name=input" json:"input,omitempty"`
	Nonce            *uint64 `protobuf:"varint,10,opt,name=nonce" json:"nonce,omitempty"`
	To               []byte  `protobuf:"bytes,11,opt,name=to" json:"to,omitempty"`
	TransactionIndex *uint64 `protobuf:"varint,12,opt,name=transaction_index,json=transactionIndex" json:"transaction_index,omitempty"`
	Value            []byte  `protobuf:"bytes,13,opt,name=value" json:"value,omitempty"`
	Type             *uint64 `protobuf:"varint,14,opt,name=type" json:"type,omitempty"`
	Accesses         []byte  `protobuf:"bytes,15,opt,name=accesses" json:"accesses,omitempty"`
	ChainId          *uint64 `protobuf:"varint,16,opt,name=chain_id,json=chainId" json:"chain_id,omitempty"`
	V                []byte  `protobuf:"bytes,17,opt,name=v" json:"v,omitempty"`
	R                []byte  `protobuf:"bytes,18,opt,name=r" json:"r,omitempty"`
	S                []byte  `protobuf:"bytes,19,opt,name=s" json:"s,omitempty"`
}
...
func (x *Transaction) GetGasFeeCap() uint64 {
	if x != nil && x.GasFeeCap != nil {
		return *x.GasFeeCap
	}
	return 0
}

func (x *Transaction) GetGasTipCap() uint64 {
	if x != nil && x.GasTipCap != nil {
		return *x.GasTipCap
	}
	return 0
}
...
func (x *Transaction) GetAccesses() []byte {
	if x != nil {
		return x.Accesses
	}
	return nil
...
var file_aspect_v2_host_api_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x12, 0x0e, 0x0a, 0x02, 0x74, 0x6f, 0x18, 0x02, 0x20, 0x02, 0x28, 0x0c, 0x52, 0x02,
	0x74, 0x6f, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x02, 0x28, 0x0c,
	...
	0x74, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x0a, 0x20, 0x02, 0x28, 0x03, 0x52, 0x0b, 0x70,
	...
	0x20, 0x02, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xda, 0x03, 0x0a, 0x0b, 0x54,
	0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1d, 0x0a, 0x0a, 0x62, 0x6c,
	0x6f, 0x63, 0x6b, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x01, 0x20, 0x02, 0x28, 0x0c, 0x52, 0x09,
	0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x61, 0x73, 0x68, 0x12, 0x21, 0x0a, 0x0c, 0x62, 0x6c, 0x6f,
	0x63, 0x6b, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x02, 0x20, 0x02, 0x28, 0x04, 0x52,
	...
	,
	...
	,
	...
	0x77, 0x6f, 0x72, 0x6b, 0x2f, 0x61, 0x73, 0x70, 0x65, 0x63, 0x74, 0x2d, 0x63, 0x6f, 0x72, 0x65,
	0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0xa2, 0x02, 0x03, 0x41, 0x58, 0x58, 0xaa, 0x02, 0x09, 0x41,
	0x73, 0x70, 0x65, 0x63, 0x74, 0x2e, 0x56, 0x32, 0xca, 0x02, 0x09, 0x41, 0x73, 0x70, 0x65, 0x63,
	0x74, 0x5c, 0x56, 0x32, 0xe2, 0x02, 0x15, 0x41, 0x73, 0x70, 0x65, 0x63, 0x74, 0x5c, 0x56, 0x32,
	0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0a, 0x41,
	0x73, 0x70, 0x65, 0x63, 0x74, 0x3a, 0x3a, 0x56, 0x32,
}
...
var file_aspect_v2_host_api_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_aspect_v2_host_api_proto_goTypes = []interface{}{
	...
	(*Transaction)(nil),           // 24: aspect.v2.Transaction
	nil,                           // 25: aspect.v2.EthCallTree.CallsEntry
}
var file_aspect_v2_host_api_proto_depIdxs = []int32{
	...
	25, // 4: aspect.v2.EthCallTree.calls:type_name -> aspect.v2.EthCallTree.CallsEntry
...
func file_aspect_v2_host_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_aspect_v2_host_api_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
