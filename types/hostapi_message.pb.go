...
var file_aspect_v1_hostapi_message_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x42, 0x94, 0x01, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x73, 0x70, 0x65, 0x63,
	0x74, 0x2e, 0x76, 0x31, 0x42, 0x13, 0x48, 0x6f, 0x73, 0x74, 0x61, 0x70, 0x69, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x29, 0x67, 0x69, 0x74,
	...
	0x73, 0x70, 0x65, 0x63, 0x74, 0x2e, 0x56, 0x31, 0xca, 0x02, 0x09, 0x41, 0x73, 0x70, 0x65, 0x63,
	0x74, 0x5c, 0x56, 0x31, 0xe2, 0x02, 0x15, 0x41, 0x73, 0x70, 0x65, 0x63, 0x74, 0x5c, 0x56, 0x31,
	0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0a, 0x41,
	0x73, 0x70, 0x65, 0x63, 0x74, 0x3a, 0x3a, 0x56, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_aspect_v1_hostapi_message_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_aspect_v1_hostapi_message_proto_goTypes = []interface{}{
	...
	(*BlockOutput_Result)(nil), // 8: aspect.v1.BlockOutput.Result
}
var file_aspect_v1_hostapi_message_proto_depIdxs = []int32{
	3, // 0: aspect.v1.AspectInput.tx:type_name -> aspect.v1.AspTransaction
	2, // 1: aspect.v1.AspTransaction.accessList:type_name -> aspect.v1.AspAccessTuple
	8, // 2: aspect.v1.BlockOutput.res:type_name -> aspect.v1.BlockOutput.Result
	6, // 3: aspect.v1.BlockOutput.block:type_name -> aspect.v1.EthBlock
	7, // 4: aspect.v1.EthBlock.header:type_name -> aspect.v1.EthHeader
	7, // 5: aspect.v1.EthBlock.uncles:type_name -> aspect.v1.EthHeader
	3, // 6: aspect.v1.EthBlock.transactions:type_name -> aspect.v1.AspTransaction
